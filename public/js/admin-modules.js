...
async function deleteStaffMaster(id,name){
  ...
  if(!attendanceSnap.empty||!advanceSnap.empty){alert(`${name} has attendance/payroll or operational history and cannot be permanently deleted. Deactivate the staff account instead.`);return;}
